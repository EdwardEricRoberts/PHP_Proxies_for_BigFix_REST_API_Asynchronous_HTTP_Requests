<?php
// Returns a list of Computers withe their Operating Systems Information.  Can also be filtered by Computer Group.
	...
	$relevance = 
		...
		'( '.
			...
			//'(concatenation "<br>" of values of results from (bes property "RAM") of it as string), '.
			'('.
	...
	if ($filter == "All Machines") {  // This is what I used for my "return everything" state, no Computer Group with that name existed
		$relevance .= 
			'bes computers ';
	}
	else {
