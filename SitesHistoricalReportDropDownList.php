<?php
// A simple list of Sites for the purpose of populating a drop down list in HTML.
	...
	$relevance = 
		...
		'whose '.
		'( '.
			'(external site flag of it = TRUE) or '.
			'(master site flag of it = TRUE) '.
			//'or (custom site flag of it = TRUE) '.
			//'or (operator site flag of it = TRUE)'.
		')';
