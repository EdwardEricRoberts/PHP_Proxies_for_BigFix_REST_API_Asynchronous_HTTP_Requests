<?php
//  Returns a list of Computer Groups that also lists the type of group as well as the name of the group's Parent Site that the group extends from.
	...
	$relevance = 
		'( '.
			...
			'names of it, '.
			'( '.
				'if (manual flag of it = TRUE) '.
				'then ("manual") '.
				'else '.
				'( '.
					'if (automatic flag of it = TRUE) '.
					'then ("automatic") '.
					'else ("ad-hoc") '.
				') '.
			'), '.
