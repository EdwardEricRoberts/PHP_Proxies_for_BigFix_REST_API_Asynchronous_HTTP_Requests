<?php
	...
	$relevance = 
		'( '.
			...
			'(substring after "https://" of it) of url of item 1 of it as string '.
			//'(substring before ":42311" of (substring after "https://" of it)) of url of item 1 of it as string'.
		') of '.
		'( '.
			'bes users'.
			', current bes server'.
	...
	// BigFix REST API URL
	$url = "https://".$server."/api/query?relevance=".$relevance; //:42311
