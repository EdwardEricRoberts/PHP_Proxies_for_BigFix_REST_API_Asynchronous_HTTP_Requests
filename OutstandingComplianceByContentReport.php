<?php
	...
	$relevance = 
		...
		'( '.
			...
			'item 2 of it, '.
			'( '.
				'if ((item 1 of it + item 2 of it) = 0) '.
				'then ("N/A") '.
				'else (((item 1 of it as floating point / (item 1 of it as floating point + item 2 of it as floating point)) * 100) as integer as string & "%") '.
			') '.
		') '.
		'of '.
		'( '.
