<?php
	...
	$searchUser = str_replace('%', '%252525', $searchUser);
	$searchUser = str_replace(' ', '%20', $searchUser);
	$searchUser = str_replace('!', '%21', $searchUser);
	$searchUser = str_replace('"', '%22', $searchUser);
	$searchUser = str_replace('#', '%23', $searchUser);
	$searchUser = str_replace('$', '%24', $searchUser);
	$searchUser = str_replace('&', '%26', $searchUser);		// ' = %27
	$searchUser = str_replace('*', '%2A', $searchUser);
	$searchUser = str_replace('+', '%2B', $searchUser);
	$searchUser = str_replace(',', '%2C', $searchUser);
	$searchUser = str_replace('-', '%2D', $searchUser);
	$searchUser = str_replace('.', '%2E', $searchUser);
	$searchUser = str_replace('/', '%2F', $searchUser);
	$searchUser = str_replace(':', '%3A', $searchUser);
	$searchUser = str_replace(';', '%3B', $searchUser);
	$searchUser = str_replace('<', '%3C', $searchUser);
	$searchUser = str_replace('=', '%3D', $searchUser);
	$searchUser = str_replace('>', '%3E', $searchUser);
	$searchUser = str_replace('?', '%3F', $searchUser);
	$searchUser = str_replace('@', '%40', $searchUser);
	$searchUser = str_replace('\\', '%5C', $searchUser);
	$searchUser = str_replace('_', '%5F', $searchUser);
	$searchUser = str_replace('~', '%7E', $searchUser);
	
	// BigFix REST API URL
	if($siteType == 'master') {
		$url = "https://".$server."/api/site/".$siteType."/permission/operator/".$searchUser;
	}
	else {
		$url = "https://".$server."/api/site/".$siteType."/".$site."/permission/operator/".$searchUser;
	}
